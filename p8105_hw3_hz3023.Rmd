...
```
There are `r nrow(filter(Q2, months == 116))` codes are observed in all 116 months.There are `r nrow(filter(Q2, months < 10))` codes are observed fewer than 10 times.
